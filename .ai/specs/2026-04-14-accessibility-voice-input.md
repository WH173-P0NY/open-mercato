...
- **Integration coverage**: Added `packages/core/src/modules/auth/__integration__/TC-AUTH-027.spec.ts` and `packages/enterprise/src/modules/security/__integration__/TC-SEC-009.spec.ts`.
